  ...
  <div>
    <div class="home-main">
      <div class="content">
        ...
        <h3>Original taste from Sam's Gyros 😋</h3>
        <p>
          We guarantee to use fresh food with the best quality. Customers will
          enjoy cuisine with explosive, sophisticated flavors.
        </p>
      ...
      <!-- <div class="image">
        <video  type="video/mp4"  preload="auto" webkit-playsinline="1" playsinline="true" src="../assets/images/Video/petal_20240129_101710.mp4"  autoplay="" loop=""></video>
    ...
    <div class="home-category">
      <router-link @click="scrollToTop()" to="/menu" class="box">
        <img src="../assets/images/Platter.png" alt="" />
        <h3>Platter</h3>
      </router-link>
    ...
    <div class="home-banner">
      <div class="grid-banner row">
        ...
        <div class="grid col-md-4">
          ...
          <div class="content center">
            <span style="color: white;">we offer catering services</span>
            <h3 style="color: white;">with special pricing</h3>
              <!-- <router-link @click="scrollToTop()" to="/menu" class="btn"
                >order now</router-link
              > -->
          </div>
    ...
    <div class="home-about">
      ...
      <div class="content">
        ...
        <p>
          ...
          are prepared and always served fresh, Promising To Bring Explosive and
          delicate. Customers Can Enjoy The Same Quality At The Restaurant
        </p>
          ...
          <div class="icons-container">
            ...
            <div class="icons">
              <img
                ...
                alt=""
                href="https://maps.app.goo.gl/TMXH7Kn4UUkbmjzd8"
              />
