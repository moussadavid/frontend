      ...
      <div class="about-content">
        ...
        <div class="about-content-text">
          <p>
            ...
            <p>
            OUR meals, the products that we deliver to
            customers are always the best quality products.
          </p>
          <p>
            Customers can eat at the restaurant to experience the atmosphere or
            can order the food and picked up within 30 min.
          </p>
        </div>
      </div>
    </div>
