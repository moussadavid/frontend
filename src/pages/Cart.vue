        ...
        <div class="row">
          <div class="in-cart col-md-8">
            <div class="box">
              ...
              <div v-else>
                <div v-for="(f, index) in cartItem" :key="index">
                  <div class="box-content row">
                    <div class="image-box col-sm-3" style="padding-left: 0">
                      <img
                        :src="
                          require(`../assets/images/${
                            getFoodItem(this.filterFoods, this.cartItem[index])
                              .food_src
                          }`)
                        "
                        alt=""
                    ...
                    <div class="desc col-sm-4">
                      ...
                      <div class="item-desc">
                        <b>Side Salad</b>
                        <p>{{ side_salad[index] }}</p>
                      </div>
<div class="item-desc">
                        <b>Special requests</b>
                        <p>{{ special_requests[index] }}</p>
                      </div>
          ...
          <div class="col-md-4">
            ...
            <div class="box">
              ...
              <div class="box-content text-center">
                <h3><i class="fa fa-phone"></i>(502) 709-4292</h3>
                <span class="small">
...
export default {
  ...
  methods: {
    ...
    calculateItemPrice: function (index) {
      let foodItem = this.getFoodItem(this.filterFoods, this.cartItem[index]);
      return (
        (parseFloat(foodItem.food_price) - parseFloat(foodItem.food_discount)) *
    ...
    calculateSummaryPrice: function () {
      ...
      while (i < this.itemQuantity.length) {
        ...
        subtotal =
          subtotal +
          parseFloat(foodItem.food_price) * this.itemQuantity[i];
        discount =
          discount +
          parseFloat(foodItem.food_discount) * this.itemQuantity[i];
        i = i + 1;
      }
      if (!this.filterFoods.length) {
        ...
        Taxfees = parseFloat((((tax + subtotal)* config.stripFees)) / 100) + config.stripFixedFees + tax;
      }
    ...
    async onQtyChange(e, i) {
      ...
      let data = {
        ...
        side_salad: this.side_salad[i],
        special_requests: this.special_requests[i],
      };
